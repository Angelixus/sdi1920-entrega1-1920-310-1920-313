...
public class SeleniumUtils {
	...
	/**
	 * Este metodo espera a que cargue la pagina y comprueba que el elemento que
	 * deberia retornar el xpath no existe
	 * 
	 * @param driver: apuntando al navegador abierto actualmente.
	 * @param xpath: la consulta xpath para buscar el elemento
	 * @param timeout: el tiempo de espera maximo
	 * @return
	 */
